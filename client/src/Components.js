        ...
        return (
            <div className="d-flex flex-wrap justify-content-between">
                {this.props.contacts.map((contact, index) =>
                    <Contact contact={contact} key={index} updateContact={this.props.updateContact}
        ...
        return (
            <form onSubmit={this.submitForm}>
                <div>
                    ...
                    <input className="form-control" type="text" name="name" value={this.props.contact.name} required
                           onChange={this.changeName}/>
                </div>
                <div>
                    <label className="form-label">Lastname: </label>
                    <input className="form-control" type="text" name="lastname" value={this.props.contact.lastname}
                           required onChange={this.changeLastname}/>
                </div>
                <div>
                    <label className="form-label">Company: </label>
                    <input className="form-control" type="text" name="company" value={this.props.contact.company}
                           onChange={this.changeCompany}/>
                </div>
                <div>
                    <label className="form-label">Phone: </label>
                    <input className="form-control" type="text" name="phone" value={this.props.contact.phone}
                           onChange={this.changePhone}/>
                </div>
                <div>
                    <label className="form-label">Email: </label>
                    <input className="form-control" type="email" name="email" value={this.props.contact.email} required
                ...
                <div>
                    <input className="btn btn-primary m-1" type="submit" value="Submit"/>
                    {
                        this.props.contact._id ?
                            <button className="btn btn-warning m-1" onClick={this.resetForm}>Reset</button> : null
                    }
                </div>
                {
                    this.state.message ?
                        <div className="badge badge-light m-4">{this.state.message} <span className="badge badge-light"
                                                                                          onClick={this.closeMessage}>x</span>
                        </div> : null
                }
